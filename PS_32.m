...
dlmwrite('PS_32_xhatfirst0',xhat_first_collect0,'delimiter',',')
dlmwrite('PS_32_xhatfirst',xhat_first_collect,'delimiter',',')
dlmwrite('PS_32_0var',ResidualVar,'delimiter',',')
dlmwrite('PS_32_nstar',nstar,'delimiter',',')
dlmwrite('PS_32_var',GXvar,'delimiter',',')
dlmwrite('PS_32_L2',GXL2,'delimiter',',')
dlmwrite('PS_32_false',false,'delimiter',',')
