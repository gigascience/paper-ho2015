% This program is to study the Block-Diagonal (BD) model with s=5, using
% the real data.
...
dlmwrite('Data_5_xhatfirst0',xhat_first_collect0,'delimiter',',')
dlmwrite('Data_5_xhatfirst',xhat_first_collect,'delimiter',',')
dlmwrite('Data_5_0var',ResidualVar,'delimiter',',')
dlmwrite('Data_5_nstar',nstar,'delimiter',',')
dlmwrite('Data_5_var',GXvar,'delimiter',',')
dlmwrite('Data_5_L2',GXL2,'delimiter',',')
dlmwrite('Data_5_false',false,'delimiter',',')
