% This program is to study the Promiscuous (PS) model with s=30 and s'=20, 
...
for nshuffle = 1:nshuffle_max
 ...
 genotype = A_Matrix_big(:,randperm(p));
...
random = zeros(n,1);
random(1:n) = RandomVector_big(1:n); 
y3 = sqrt(1-h2)*random;
...
dlmwrite('PS_3020_xhatfirst0',xhat_first_collect0,'delimiter',',')
dlmwrite('PS_3020_xhatfirst',xhat_first_collect,'delimiter',',')
dlmwrite('PS_3020_0var',ResidualVar,'delimiter',',')
dlmwrite('PS_3020_nstar',nstar,'delimiter',',')
dlmwrite('PS_3020_var',GXvar,'delimiter',',')
dlmwrite('PS_3020_L2',GXL2,'delimiter',',')
dlmwrite('PS_3020_false',false,'delimiter',',')
