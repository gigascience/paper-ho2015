...
dlmwrite('BD_5_xhatfirst0',xhat_first_collect0,'delimiter',',')
dlmwrite('BD_5_xhatfirst',xhat_first_collect,'delimiter',',')
dlmwrite('BD_5_0var',ResidualVar,'delimiter',',')
dlmwrite('BD_5_nstar',nstar,'delimiter',',')
dlmwrite('BD_5_var',GXvar,'delimiter',',')
dlmwrite('BD_5_L2',GXL2,'delimiter',',')
dlmwrite('BD_5_false',false,'delimiter',',')
