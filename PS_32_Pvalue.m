% This program is to plot the median p-value against n in the Promiscuous 
% (PS) model with s=3 and s'=2, using the synthetic data.
...
plot(step,Pvalue_n,'r*')
set(gca,'FontSize',11)
xlabel('n','interpreter','latex','FontSize',20)
ylabel('median $p$-value','interpreter','latex','FontSize',20)
axis([0 2000 -0.0002 0.0005])
get(0,'screensize')
saveas(gcf,'Pvalue_vs_n.jpg')
